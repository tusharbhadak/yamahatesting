...
function changeColor(button, color) {
    ...
    if (color === 'mey1') {
        document.getElementById('mey1_color_details').style.display = 'block';
        document.getElementById('mey2_color_details').style.display = 'none';
        document.getElementById('mey3_color_details').style.display = 'none';
        document.getElementById('mey4_color_details').style.display = 'none';
    } else if (color === 'mey2') {
        document.getElementById('mey1_color_details').style.display = 'none';
        document.getElementById('mey2_color_details').style.display = 'block';
        document.getElementById('mey3_color_details').style.display = 'none';
        document.getElementById('mey4_color_details').style.display = 'none';
    }
    else if (color === 'mey3') {
        document.getElementById('mey1_color_details').style.display = 'none';
        document.getElementById('mey2_color_details').style.display = 'none';
        document.getElementById('mey3_color_details').style.display = 'block';
        document.getElementById('mey4_color_details').style.display = 'none';
    }
    else if (color === 'mey4') {
        document.getElementById('mey1_color_details').style.display = 'none';
        document.getElementById('mey2_color_details').style.display = 'none';
        document.getElementById('mey3_color_details').style.display = 'none';
        document.getElementById('mey4_color_details').style.display = 'block';
    }
