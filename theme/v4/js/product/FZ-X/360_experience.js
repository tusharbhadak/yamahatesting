...
//             momattecopperetailsTitle: "Read More",
//             momattecopperetailsUrl: "https://www.forcegurkha.co.in/specifications/"
//         }
//     }
// ]
...
function changeColor(button, color) {
    ...
    if (color === 'mattetitan') {
        document.getElementById('mattetitan_color_details').style.display = 'block';
        document.getElementById('chrome_color_details').style.display = 'none';
        ...
        document.getElementById('mattecopper_color_details').style.display = 'none';
    } else if (color === 'chrome') {
        document.getElementById('mattetitan_color_details').style.display = 'none';
        document.getElementById('chrome_color_details').style.display = 'block';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('mattecopper_color_details').style.display = 'none';
    }
    ...
    else if (color === 'mattecopper') {
        document.getElementById('mattetitan_color_details').style.display = 'none';
        document.getElementById('chrome_color_details').style.display = 'none';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('mattecopper_color_details').style.display = 'block';
    }
