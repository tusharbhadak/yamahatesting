...
function changeColor(button, color) {
    ...
    if (color === 'cyan') {
        ...
        document.getElementById('cybergreen_color_details').style.display = 'none';
        document.getElementById('ice_color_details').style.display = 'none';
        document.getElementById('blackdlx_color_details').style.display = 'none';
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'none';
    } else if (color === 'blue') {
        ...
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'none';
    } else if (color === 'cybergreen') {
        document.getElementById('cyan_color_details').style.display = 'none';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('cybergreen_color_details').style.display = 'block';
        document.getElementById('ice_color_details').style.display = 'none';
        document.getElementById('blackdlx_color_details').style.display = 'none';
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'none';
        ...
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('cybergreen_color_details').style.display = 'none';
        document.getElementById('ice_color_details').style.display = 'block';
        document.getElementById('blackdlx_color_details').style.display = 'none';
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'none';
    } else if (color === 'blackdlx') {
        document.getElementById('cyan_color_details').style.display = 'none';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('cybergreen_color_details').style.display = 'none';
        document.getElementById('ice_color_details').style.display = 'none';
        document.getElementById('blackdlx_color_details').style.display = 'block';
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'none';
    } else if (color === 'bluedlx') {
        document.getElementById('cyan_color_details').style.display = 'none';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('cybergreen_color_details').style.display = 'none';
        document.getElementById('ice_color_details').style.display = 'none';
        document.getElementById('blackdlx_color_details').style.display = 'none';
        document.getElementById('bluedlx_color_details').style.display = 'block';
        document.getElementById('motogp_color_details').style.display = 'none';
    } else if (color === 'motogp') {
        document.getElementById('cyan_color_details').style.display = 'none';
        document.getElementById('blue_color_details').style.display = 'none';
        document.getElementById('black_color_details').style.display = 'none';
        document.getElementById('cybergreen_color_details').style.display = 'none';
        ...
        document.getElementById('blackdlx_color_details').style.display = 'none';
        document.getElementById('bluedlx_color_details').style.display = 'none';
        document.getElementById('motogp_color_details').style.display = 'block';
    }
