...
const specifications = {
    "MT15 V2": {
        "Engine": [
            ...
            { "title": "Maximum horse power", "value": "13.5kW(18.4PS)/10000r/min" },
            ...
            { "title": "Maximum torque", "value": "14.1N.m(1.4kgf.m)/7500r/min" },
            { "title": "Fuel System", "value": "Fuel injection" }
        ],
        "Dimensions": [
            { "title": "Overall length", "value": "2015mm" },
            { "title": "Overall Width", "value": "800mm" },
            { "title": "Overall Height", "value": "1,070mm" },
            { "title": "Minimum ground clearance", "value": "170 mm" },
            { "title": "Kerb Weight(with oil & a full fuel tank)", "value": "141 kg" },
            { "title": "Seat height", "value": "810mm" },
            { "title": "Inner tube diameter of front fork", "value": "37.0mm" },
            { "title": "Wheelbase", "value": "1,325 mm" },
            { "title": "Fuel tank capacity", "value": "10L" },
        ],
        "Chassis": [
            { "title": "Frame type", "value": "Deltabox" },
            { "title": "Front suspension system", "value": "Telescopic upside down Front Fork" },
            { "title": "Rear suspension system", "value": "Linked-Type Monocross Suspension" },
            ...
            { "title": "Tyre size (rear)", "value": "140/70R-17M/C 66H - Radial Tubeless" },
        ...
        "Other Info": [
            ...
            { "title": "Fuel gauge", "value": "Digital" },
            { "title": "Hazard Function", "value": "Equipped*" },
            ...
            { "title": "Y-Connect (Smartphone Bluetooth Connectivity)", "value": "Equipped, *Not equipped in Metallic Black & Dark Matte Blue" },
            { "title": "Traction control system", "value": "Equipped" },
            { "title": "Riding Modes", "value": "Track Mode / Street Mode" },
            { "title": "Quick shifter(up-shift)", "value": "Equipped" },
        ]
    },
...
function activateTab(tabIndex) {
    ...
    const activeProduct = "MT15 V2"; // You can change this dynamically based on the product being displayed
